...
<h2><img src="<?php echo HOME?>/img/icons/orders.png"/> <?php __('Orders')?></h2>
</div>

<table cellpadding="0" cellspacing="0" class="maintable_orders">
	<tr class="tablehead">
		<td width="80px"><p><?php __('Bedrag')?></p></td>
		<td width="100px"><p><?php echo $paginator->sort(__('Ordernummer', true), 'id'); ?></p></td>
		<td width="200px"><p><?php __('Klant')?></p></td>
		<td style="text-align:left" width="80px"><p><?php echo $paginator->sort('Datum', 'created'); ?></p></td>
		<td  style="text-align:left"><p style="margin:0px; margin-top:0px; margin-left:30px;"><?php __('Acties')?></p></td>
	</tr>
	...
	<tr<?php echo $class;?>>
		<td style="text-align:left" <?php echo $tdclass?>>
			...
			<p><?php echo $number->currency($totalboth, CURRENCY)?></p>
			<small>(<?php __('Niet betaald')?>)</small>
			<?php else: ?>
			<p><?php echo $number->currency($totalboth, CURRENCY)?></p>
			<?php endif; ?>
		</td>
		...
		<td>
			<div class="info"><small><a href="<?php echo HOME?>/admin/vieworder/<?php echo $order['Order']['id']?>"><?php __('Bekijk')?></a></small></div>
			<?php if($order['Order']['paid'] == '0'):?>
			<div class="pay"><small><a href="<?php echo HOME?>/admin/orderpaid/<?php echo $order['Order']['id']?>"><?php __('Wel betaald')?></a></small></div>
			<?php else: ?>
			<div class="pay"><small><a href="<?php echo HOME?>/admin/orderpaid/<?php echo $order['Order']['id']?>"><?php __('Niet betaald')?></a></small></div>
			<?php endif;?>
		</td>
	</tr>
	<?php endforeach; ?>
