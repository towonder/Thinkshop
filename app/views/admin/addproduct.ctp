...
<table>
	...
	<tr>
		<td><input type="text" name="data[Product][name]" class="title_text" value="Product naam" id="productname" onclick="doSmartEmpty('#productname', 'Product naam');"></td>
	</tr>
	<tr>
		<td>
...
<div id="editsidebar">
	...
	<div id="publish">
		...
		<table id="publishtable" style="width:240px; margin-left:10px">
			...
			<tr>
				<td>
					<input type="submit" name="Publiceer" value="Publiceer" class="submitbutton" style="margin-left:0px">
				</td>
				<td style="text-align:right">
					<input type="submit" name="Bewaar" value="Bewaar" style="margin-right:10px" class="submitbutton">		
				</td>
			</tr>
		</table>
	</div>
